...
class CircularLinkedList:
    ...
    def insertlast(self, data ):
        if(self.root is None ):
            ...
            current_Node = self.root.Node
            while(current_Node.Node!=self.root):
